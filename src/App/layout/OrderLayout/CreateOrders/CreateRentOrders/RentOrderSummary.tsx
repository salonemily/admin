...
import { IRentOrderSummaryData } from "../common/ordersAddons";
interface Iprops {
  data: IRentOrderSummaryData;
  submit: (values: any) => void;
}
const RentOrderSummary: React.FC<Iprops> = ({ data, submit }) => {
            ...
            <Fragment>
              ...
              {order && (
                <List>
                  ...
                  <List.Item>
                    Data wyporzyczenia: {order.rentStartDate}
                  </List.Item>
                  <List.Item>
                    Data oddania: {order.rentEndDate}
                  </List.Item>
...
export default RentOrderSummary;
